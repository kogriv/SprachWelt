...
- ### Морфология
**Фокус:** Структура и формы слов, классификация слов по частям речи, образование и изменение слов.  
...
## Типология языков
**Описание:** Классификация языков по структурным и функциональным признакам.  
